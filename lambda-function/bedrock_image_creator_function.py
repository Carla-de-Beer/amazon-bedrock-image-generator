...
client_bedrock = boto3.client('bedrock-runtime', region_name=os.environ['REGION_NAME'])
...
def lambda_handler(event, context):
    ...
    try:
        ...
        for i in range(number_of_images):
            ...
            generated_presigned_url = client_s3.generate_presigned_url('get_object', Params={'Bucket': os.environ['IMAGE_STORAGE_BUCKET'],'Key':image_name}, ExpiresIn=3600)
